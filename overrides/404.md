...
<body>
    <section class="notFound">
        ...
        <div class="text">
        <h1>Sorry!</h1>
        <h2>Seems like the flux capacitor is broken, it only responds with "404"?!?</h2>
        <h3>Let's start all over from</h3>
        <a href="https://1coderookie.github.io/KobraGoNeoInsights" class="yes">HOME of <br> 1coderookie's <br> "KobraGoNeo Insights"</a>
        </div>
    </section>
</body>
</html>
