...
- @[TheUnlimited64](https://github.com/TheUnlimited64) offers a [modified Kobra **Neo** firmware with (up to him) working *Linear Advance*](https://github.com/TheUnlimited64/Kobra_Neo_Firmware)
