...
## Z-Axis
The Z-axis of both the **Go** and the **Neo** is driven by a single lead screw, diameter 8mm with 2mm pitch per rotation. The rod is mounted to the motor by a coupler at the bottom. The top end of the rod is completely unguided, in between it's guided and secured by an anti-backlash nut which you can see at the following picture, it's the black plastic part mounted to the black steel bracket.  
...
??? tip "Rod Maintenance"
    ...
    !!! warning "Don't Use WD-40 For Lubrication"
        ...
        Do yourself a favour and *don't* use WD-40 for *lubrication* as it's *not* a lubricant!  
