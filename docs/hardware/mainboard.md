...
Afaik it is a 32bit mainboard with a Huada HC32F460 200MHz ARM Cortex-M4 with 192KB SRAM and 512KB Flash. The mainboard comes with TMC2208 silent stepper drivers soldered onto the board. It offers a microSD card reader and a USB-C connector.    
